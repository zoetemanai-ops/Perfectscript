...
async function renderConcept(runId, concept, refFiles, creatorName) {
  ...
  const quality = isTweet
    ...
    'The ROOM reads lived-in and naturally imperfect — never a sterile, perfectly symmetrical studio set. ' +
    ...
    'The caption text stays sharp and fully legible, but shares the photograph\u2019s white balance and exposure so it reads as part of the image, never as a pasted sticker.';
